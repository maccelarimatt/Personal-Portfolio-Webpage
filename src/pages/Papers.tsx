...
const PapersPage = () => (
  <PageTransition>
    <Section
      ...
      eyebrow="Writing"
      description="Academic-style outputs, reports, and technical notes. Each piece is concise and focuses on actionable insights."
    >
      <div className="space-y-4">
        {papers.map((paper, idx) => (
          ...
          >
            ...
            />
            <div className="mt-2 inline-flex items-center gap-2 rounded-full border border-border/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-white">
              <BookOpen size={14} />
              {paper.venue}
            </div>
          </Card>
